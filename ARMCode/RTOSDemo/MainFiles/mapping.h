...
void vStartMappingTask(mappingStruct *mapData,unsigned portBASE_TYPE uxPriority, navigationStruct *navData, speedLimitControlStruct *speedData, vtLCDStruct *lcdData);
